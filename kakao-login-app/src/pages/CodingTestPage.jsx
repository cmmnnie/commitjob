                ...
                {!selectedProblem ? (
                    <>
                        ...
                        <div style={{
                            ...
                            <h2 style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '12px', color: '#1a202c' }}>
                                💻 코딩 테스트
                            </h2>
                            <p style={{ color: '#4a5568', lineHeight: '1.8', margin: 0, fontSize: '15px' }}>
                                기업별 코딩 테스트 문제를 풀어보고 실력을 향상시킬 수 있습니다.<br/>
